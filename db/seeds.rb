...
animal10.save
animal11 = Animal.new(shelter_id: shelter.id, category: "dog",name: "Buddy", gender: "boy", age: "Teenager", size: "M", remote: false,  animal_bio:"Buddy came back to us. In his previous home Buddy bit. For this reason, we place him only to dog-experienced animal friends who will treat him with a lot of patience and calmness. In the beginning Buddy is a rather fearful and reserved guy. In his first days here at the shelter, he didn't really want to let anyone get close to him, but once the ice was broken, he never left his keepers' side. He is a very loyal dog.")
